    ...
    public partial class AddClientForm : Form
    {
        ...
        private void BtnAdd_Click(object sender, EventArgs e)
        {
            if (Utils.CheckFIO(TxtName.Text) && Utils.CheckFIO(TxtLastName.Text))
            {
                ...
                else MessageBox.Show("Проверьте корректность  email");
            }
            else MessageBox.Show("Проверьте корретность введенных данных 'Фамилия' и 'Имя'");
        }
        ...
        private void AddPhoto_Click(object sender, EventArgs e)
        {
            using(OpenFileDialog openFile = new OpenFileDialog()){
                ...
                {
                    MessageBox.Show("Файл не является графическим объектом!");
                }
            }
